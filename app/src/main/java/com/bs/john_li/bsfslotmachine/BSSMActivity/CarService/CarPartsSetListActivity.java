...
public class CarPartsSetListActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void setListener() {
        ...
        mRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                merchatList.clear();
                pageNo = 1;
                if (BSSMCommonUtils.isLoginNow(CarPartsSetListActivity.this)) {
                    callNetGetCarWashMercahtList();
                } else {
                    startActivityForResult(new Intent(CarPartsSetListActivity.this, LoginActivity.class), BSSMConfigtor.LOGIN_FOR_RQUEST);
                }
            }
        });
        mRefreshLayout.setOnLoadmoreListener(new OnLoadmoreListener() {
            ...
            public void onLoadmore(RefreshLayout refreshlayout) {
                ...
                if (pageSize * (pageNo + 1) > totolCarCount){
                    Toast.makeText(CarPartsSetListActivity.this, "沒有更多數據了誒~", Toast.LENGTH_SHORT).show();
    ...
    public void initData() {
        ...
        mSmartCarWashMerchatRefreshAdapter.setOnItemClickListenr(new SmartCarWashMerchatRefreshAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(CarPartsSetListActivity.this, SellerCarPartsSetListActivity.class);
                intent.putExtra("merchatModel", new Gson().toJson(merchatList.get(position)));
        ...
        x.http().request(HttpMethod.POST ,params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                if (model.getCode() ==200) {
                    ...
                    SPUtils.put(CarPartsSetListActivity.this, "UserToken", "");
                    Toast.makeText(CarPartsSetListActivity.this,  String.valueOf(model.getMsg()), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(CarPartsSetListActivity.this,  String.valueOf(model.getMsg()), Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                if (ex instanceof SocketTimeoutException) {
                    Toast.makeText(CarPartsSetListActivity.this, "請求超時，請重試！", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(CarPartsSetListActivity.this, getString(R.string.no_net), Toast.LENGTH_SHORT).show();
                }
            }
            //主动调用取消请求的回调方法
            @Override
