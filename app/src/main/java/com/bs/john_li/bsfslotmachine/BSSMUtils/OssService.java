...
public class OssService {
    ...
    public OssService(OSSClient oss, String bucket, UIDisplayer UIDisplayer) {
        this.oss = oss;
        this.bucket = bucket;
    ...
    public void InitOss(OSSClient _oss) {
        this.oss = _oss;
    }
            ...
            public void onSuccess(GetObjectRequest request, GetObjectResult result) {
                ...
                ProgressInputStream progressStream = new ProgressInputStream(inputStream, new OSSProgressCallback<GetObjectRequest>() {
                    ...
                    public void onProgress(GetObjectRequest o, long currentSize, long totalSize) {
                        ...
                        UIDisplayer.displayInfo(String.valueOf(progress) + "%");
                    }
