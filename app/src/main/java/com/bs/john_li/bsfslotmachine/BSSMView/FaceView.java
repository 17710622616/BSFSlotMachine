...
/**
 * 成功失敗的笑臉和哭臉
 * Created by John_Li on 16/4/2018.
 */
...
public class FaceView extends View {
    ...
    public FaceView(Context context, AttributeSet attrs, int defStyle) {
        ...
        //获取自定义属性和默认值
        roundColor = mTypedArray.getColor(R.styleable.FaceView_roundColor, Color.rgb(2, 134, 255));
        roundProgressColor = mTypedArray.getColor(R.styleable.FaceView_roundProgressColor, Color.rgb(2, 134, 255));
        roundWidth = mTypedArray.getDimension(R.styleable.FaceView_roundWidth, 8);
