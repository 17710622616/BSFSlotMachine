...
public class SmartSecondCarListRefreshAdapter extends RecyclerView.Adapter<SmartSecondCarListRefreshAdapter.SmartRefreshViewHolder> implements View.OnClickListener{
    private List<SecondCarOutModel.DataBeanX.SecondCarModel> carList;
    private final Context mContext;
    private OSSClient oss;
    private OnItemClickListener mOnItemClickListener = null;
    private LayoutInflater mInflater;
    private LruCache<String ,BitmapDrawable> mMemoryCache;
    private ImageOptions options = new ImageOptions.Builder().setImageScaleType(ImageView.ScaleType.FIT_XY).setSize(0, 0).setLoadingDrawableId(R.mipmap.img_loading).setFailureDrawableId(R.mipmap.load_img_fail_list).build();

    public SmartSecondCarListRefreshAdapter(Context context, List<SecondCarOutModel.DataBeanX.SecondCarModel> list, OSSClient oss) {
        this.carList = list;
        this.oss = oss;
        mContext = context;
    ...
    @Override
    public SmartSecondCarListRefreshAdapter.SmartRefreshViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(SmartSecondCarListRefreshAdapter.SmartRefreshViewHolder holder, int position) {
     ...
     */
    public static void downloadImgByTag(final String object, OSSClient oss, final ImageView iv, final Context context, final int fialImgRes,final SmartSecondCarListRefreshAdapter adapter) {
    ...
    public void refreshListView(List<SecondCarOutModel.DataBeanX.SecondCarModel> newList){
