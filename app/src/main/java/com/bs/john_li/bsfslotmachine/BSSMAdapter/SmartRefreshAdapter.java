...
public class SmartRefreshAdapter extends RecyclerView.Adapter<SmartRefreshAdapter.SmartRefreshViewHolder> implements View.OnClickListener {
    ...
    @Override
    public SmartRefreshAdapter.SmartRefreshViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_contents, parent, false);
        SmartRefreshViewHolder vh = new SmartRefreshViewHolder(view);
        vh.contentsIv = view.findViewById(R.id.item_contents_iv);
        vh.contentsTitle = view.findViewById(R.id.item_contents_title);
        vh.contentsPostID = view.findViewById(R.id.item_contents_postid);
        vh.contentsComment = view.findViewById(R.id.item_contents_comments);
     ...
     */
    public static void downloadImgByTag(final String object, OSSClient oss, final ImageView iv, final Context context, final int fialImgRes,final SmartRefreshAdapter adapter) {
