...
public class CollectionCarListFragment extends LazyLoadFragment {
    ...
    private void callNetGetCarList() {
        RequestParams params = new RequestParams(BSSMConfigtor.BASE_URL + BSSMConfigtor.GET_COLLECT_OLD_CAR_LIST + SPUtils.get(getActivity(), "UserToken", ""));
        ...
        x.http().request(HttpMethod.POST ,params, new Callback.CommonCallback<String>() {
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                if (ex instanceof SocketTimeoutException) {
                    Toast.makeText(getActivity(), "獲取車輛收藏列表" + getString(R.string.timeout), Toast.LENGTH_SHORT).show();
                } else {
