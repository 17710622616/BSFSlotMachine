...
public class SmartDiscountRefreshAdapter extends RecyclerView.Adapter<SmartDiscountRefreshAdapter.SmartRefreshViewHolder> implements View.OnClickListener {
    ...
    public void onBindViewHolder(SmartDiscountRefreshAdapter.SmartRefreshViewHolder holder, int position) {
        holder.item_discount_money.setText("" + list.get(position).getCouponValue());
        holder.item_discount_condition.setText("" + list.get(position).getRemark());
        holder.item_discount_limiting_condition.setText("" + list.get(position).getRemark2());
